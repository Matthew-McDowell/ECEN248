...
HD_PWD='C:/Users/justi/lab10/lab10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log combination_lock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source combination_lock.tcl -notrace
