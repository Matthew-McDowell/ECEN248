...
HD_PWD='C:/Users/justi/lab6/lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log two_four_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source two_four_decoder.tcl -notrace
