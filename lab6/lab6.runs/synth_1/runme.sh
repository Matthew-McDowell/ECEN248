...
HD_PWD='C:/Users/justi/lab6/lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_four_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_four_decoder.tcl
